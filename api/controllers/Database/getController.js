...
//                        console.log(si);
    ...
    */
    ...
    //        .populate('order_id')
        ...
        Shipmentitem.query(
            "SELECT shipi.*, sh.shipmentdate, sh.shipment_no, sh.id as shipment_id, po.price, po.orderID, po.seller, po.buyer, invi.id as invoiceitem_id, inv.id as invoice_id, inv.invoicedate, inv.paid, inv.check_no, inv.invoice_no, prod.*, shipi.id as shipmentitem_id "
